...
Extensible Markup Language (XML) je rozšiřitelný značkovací jazyk, který slouží pro popis dat. Tento jazyk vznikl na základě Standard Generalized Markup Language (SGML), který vznikl v 70. letech 20. století. Všechny správně zformátované XML dokumenty tedy zároveň i SGML dokumenty. Popis a doporučení týkající se jazyka XML lze nalézt na webových stránkách konsorcia W3C.
%TODO SGML - ref ISO 8879
%TODO ref http://www.w3.org/TR/2008/REC-xml-20081126 23.2.2016

---------------

Jazyk XML byl jednou z možností, nad kterou se uvažovalo. Jedná se o Na obrázku~\ref{img:conf_files} si lze si všimnout hlavní odlišnost formátu XML od ostatních možností. Formát XML je velice 
%TODO zkratka XML
