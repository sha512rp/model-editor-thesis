...
\section{Zápis konfiguračních souborů ve formátu YAML}
%TODO footnote style Abc.
Jak již bylo zmíněno v kapitole~\ref{sec:problematika-format-yaml}, pro zápis konfiguračních souborů se bude používat formát YAML. Jedná se o univerzální formát pro serializaci dat založený na kódování Unicode. Je navržen pro jednoduchý zápis seznamů, hashovacích tabulek a primitivních hodnot.
...
%------
V poslední fázi se převede graf reprezentující data na datovou strukturu dané aplikace. Tato fáze reprezentuje rozhraní mezi reprezentací formátu YAML a nativní datovou strukturou aplikace. a nativními datovými strukturami dané aplikace.

V každé fázi se ztratí část informace.
...
\vspace*{-20pt}
\begin{center}
\includegraphics[width=.6\textwidth]{../img/autoconversion_array_2_before.pdf}
\end{center}
\end{minipage}
\quad
\begin{minipage}[t]{0.45\linewidth}
...
\vspace*{-20pt}
\begin{center}
\includegraphics[width=.6\textwidth]{../img/autoconversion_array_2_after.pdf}
\end{center}
\end{minipage}
...
\vspace*{-20pt}
\begin{center}
\includegraphics[width=.5\textwidth]{../img/autoconversion_record_before.pdf}
\end{center}
\end{minipage}
\quad
\begin{minipage}[t]{0.45\linewidth}
...
\vspace*{-20pt}
\begin{center}
\includegraphics[width=.55\textwidth]{../img/autoconversion_record_after.pdf}
\end{center}
\end{minipage}
...
\vspace*{-20pt}
\begin{center}
\includegraphics[height=250pt]{../img/autoconversion_transposition_before.pdf}
\end{center}
\end{minipage}
\quad
...
\vspace*{-20pt}
\begin{center}
\includegraphics[height=250pt]{../img/autoconversion_transposition_after.pdf}
\end{center}
\end{minipage}
