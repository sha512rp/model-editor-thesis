...
\begin{figure}
	\centering
    \includegraphics{../img/graphs/#1.pdf}
    \caption{#2}
	\label{uml:#1}
\end{figure}
}
...
% jak se vyviji nove a upresnuji stavajici funkcionality Flow123d
% -> muze dojit k tomu, ze nektere zmeny nemusi byt zpetne kompatibilni
...
% uzivatel znovu potrebuje prostudovat ---, aby zjistil, jakym zpusobem zadat drive realizovanou ulohu pro novou verzi Flow123d
Uživatele tedy opět čeká studium rozsáhlé referenční dokumentace, aby zjistil, jaké změny má provést.

%TODO misto tak napsat potom
...
%TODO vzdalene spousteni - neni vubec interaktivni odezva, pouze se zaradi do fronty - bud se spusti okamzite, nebo se ceka na spusteni; teprve potom se projevi chyby konfiguracniho souboru - tim padem nemohlo ani dojit k inicializci, natoz k provedeni vypoctu
%TODO validace syntakticka i semanticka - (semantika - vyznam - k zadanym parametrum, kontext pouziti, vyznam dat; syntaxe = validni format yaml)
...
% gmsh/salome
% (msh, con) -> flow123d -> vystup (msh - gmsh | vtk -> paraview)
% + jednoucelove programy - uprava site, zpracovani vystupu
% preprocessing _ postprocessing - flow neresi
% riskflow - nepodporoval con, resil analyzu vysledku 
% geomop - analyza, kalibrace
...
% tvorba geometrie -> generovani site 
...
%TODO je vhodne pouzit formulaci v 1. osobe? - mel by byt jednotny zpusob projevu
...
%TODO string - z pohledu konfiguraku je strin ndelitelny - primitivni hodnota
