...
%TODO dozvi se uzivatel o chybe pomoci textoveho rozhrani nebo z vystupnich souboru?  uzivatel se o tom dozvi z logu (chybi vystupni soubory s vysledky vypoctu); informace z logu casto nejsou dostatecne nazorne aby uzivatel mohl urcit, kde a proc k chybe doslo
...
Pro tento konfigurační soubor vzniká v~rámci této práce specializovaný editor s~označením \textit{ModelEditor}, který má oproti obyčejnému textovému editoru poskytnout např. validaci zadaných dat, zobrazení kontextové dokumentace nebo automatické doplňování textu. Vytváření a~editace konfiguračních souborů se tak uživateli značně zjednoduší. \textit{ModelEditor} je jednou ze součástí aplikace GeoMop, která obsahuje i~další komponenty.
...
%TODO Pozn - tyto dalsi moduly nejsou predmetem teto diplomvoe prace
...
\begin{itemize}
	\item booleovské hodnoty, %TODO jak se to spravne oznacuje cesky?  hodnota logickeho typu
	\item celá čísla,
