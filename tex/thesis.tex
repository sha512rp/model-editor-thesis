...
Ve verzi Flow123d~1.8.2 se pro reprezentaci výše popsané datové struktury používá speciální formát \gls{con}, který byl navržen vývojáři Flow123d pro účel zápisu konfiguračních souborů. Jedná se o~formát, který vychází z~JavaScript Object Notation, který je specifikován standardem ECMA-404. Oproti tomuto standardu se liší v~několika detailech.
%TODO zkratka JSON
